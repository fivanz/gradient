const app = Vue.createApp({
    ...
    computed: {
        /*
        setColor: () => (               //arrow function debe retornar algo, retorna el siguiente CSS, es igual a loo de abajo
            `background: linear-gradient(to right, ${this.fcolor}, ${this.scolor});`
        )
        */
